package com.coolhabit.textfieldgencompose.textField.third
    ...
    LazyColumn() {
        item {
            Column(
                ...
                Text(text = "Input for Field 3", fontWeight = FontWeight.Bold, fontSize = 18.sp)
                DropDownInput(
                    label = "Align",
